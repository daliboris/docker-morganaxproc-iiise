...
```script
docker build --file Dockerfile --tag daliboris/morganaxproc-iiise:1.7.1-saxonhe-12.9-jre-21 .
``` 

```script
docker build --tag daliboris/morganaxproc-iiise:1.7.1-saxonhe-12.9-jre-21 .
``` 
...
```script
docker run -it --rm --volume C:\path\to-folder\with-xpl\files:/data daliboris/morganaxproc-iiise:1.7.1-saxonhe-12.9-jre-21
```
