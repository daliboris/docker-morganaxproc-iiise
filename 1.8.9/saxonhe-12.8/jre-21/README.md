...
```script
docker build --file Dockerfile --tag daliboris/morganaxproc-iiise:1.8.9-saxonhe-12.8-jre-21 .
``` 

```script
docker build --tag daliboris/morganaxproc-iiise:1.8.9-saxonhe-12.8-jre-21 .
``` 
...
```script
docker run -it --rm --volume C:\path\to-folder\with-xpl\files:/data daliboris/morganaxproc-iiise:1.8.9-saxonhe-12.8-jre-21
```
